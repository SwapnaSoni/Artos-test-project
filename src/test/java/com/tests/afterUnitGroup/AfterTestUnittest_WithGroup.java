...
/**
 * <PRE>
 * - Sample test to demonstrate the use of {@code @AfterTestUnit} annotation with defining group (in uppercase)
 * - Code demonstrates that method denoted with {@code @AfterTestUnit} annotation in local scope of the test case will be executed after each test unit within the same test case if its group matches with user defined group(s)
 * </PRE>
 */
...
@TestCase
public class AfterTestUnittest_WithGroup implements TestExecutable {

	@AfterTestUnit(group = { "GOODPATH", "SLOW" })
