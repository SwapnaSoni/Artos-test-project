...
public class FeatureRunner_WithBeforeGroup {
	...
	public static void main(String[] args) throws Exception {
		Runner runner = new Runner(FeatureRunner_WithBeforeGroup.class);
		runner.setTestList(getTestList());
		runner.setLoopCount(1);
		runner.setTestBeforeUnitGroupList(Lists.newArrayList("goodpath"));
