...
/**
 * <PRE>
 * - Sample test to demonstrate the use of {@code @BeforeTestUnit} annotation with defining group (in uppercase)
...
@TestCase
public class BeforeTestUnittest_WithGroup implements TestExecutable {

	@BeforeTestUnit(group = { "GOODPATH", "SLOW" })
	...
	public void testUnit_1(TestContext context) {
		// --------------------------------------------------------------------------------------------
		context.getLogger().info("testUnit_1");
		// --------------------------------------------------------------------------------------------
	}
	...
	public void testUnit_2(TestContext context) {
		// --------------------------------------------------------------------------------------------
		context.getLogger().info("testUnit_2");
		// --------------------------------------------------------------------------------------------
	}
