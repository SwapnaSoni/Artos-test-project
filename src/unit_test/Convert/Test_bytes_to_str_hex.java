...
public class Test_bytes_to_str_hex implements TestExecutable {
	...
	public void execute(TestContext context) throws Exception {
...

		{
			...
			String resultArray1 = _con.bytesToHexString(test1, true);
			...
			String resultArray2 = _con.bytesToHexString(test2, false);
...

		{
			...
			String resultArray3 = _con.bytesToHexString(test3, true);
			Guardian.guardEquals("Byte To String Hex with size", expectedResult3, resultArray3);

			byte test4 = (byte) 255;
			String expectedResult4 = "FF";
			String resultArray4 = _con.bytesToHexString(test4, false);
