...
@TestPlan(decription = "", preparedBy = "arpit", preparationDate = "1/10/2018", bdd = "GIVEN exception message is specified AND exception description has character which can be confused as regex escape characters THEN test should pass by matching description using normal string compare")
