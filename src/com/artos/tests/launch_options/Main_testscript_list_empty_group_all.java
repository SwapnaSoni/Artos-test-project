...
public class Main_testscript_list_empty_group_all implements PrePostRunnable {
	 ...
	 * AND test script, test list is empty
	...
	public static void main(String[] args) throws Exception {
		...
		Runner runner = new Runner(Main_testscript_list_empty_group_all.class);
