...
public class Main_limitedlist_group_empty implements PrePostRunnable {
	 ...
	 * AND User leaves group list empty
	...
	public static void main(String[] args) throws Exception {
		Runner runner = new Runner(Main_limitedlist_group_empty.class);
		// empty list
