...
public class Main_limitedlist_group_all implements PrePostRunnable {
	 ...
	 * AND belongs to "*" group (6 out of 6 in this case) should execute.
	 * </PRE>
	 * 
	 * @param args
	 * @throws Exception
	...
	public static void main(String[] args) throws Exception {
		Runner runner = new Runner(Main_limitedlist_group_all.class);
