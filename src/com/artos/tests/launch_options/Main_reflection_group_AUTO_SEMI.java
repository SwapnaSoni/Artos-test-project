...
public class Main_reflection_group_AUTO_SEMI implements PrePostRunnable {
	 ...
	 * AND User wish to run all test cases belongs to "AUTO" and "SEMI" groups
	 * THEN All test cases present within same package (inclusive of child packages)
	 * AND belongs to "AUTO" and "SEMI" groups (8 out of 10 in this case) should execute.
	 * </PRE>
	 * 
	 * @param args
	 * @throws Exception
	...
	public static void main(String[] args) throws Exception {
		Runner runner = new Runner(Main_reflection_group_AUTO_SEMI.class);
