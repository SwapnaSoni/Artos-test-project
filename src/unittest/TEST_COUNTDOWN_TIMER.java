...
public class TEST_COUNTDOWN_TIMER extends Test implements TestExecutor {
	...
	protected void execute(TestContext context) throws Exception {
		...
		long time = System.currentTimeMillis();
		 ...
		 cntdwn1.Start();
		 cntdwnltch1.await();
		 logger.println(Boolean.toString(cntdwn1.isButtonYesPressed()) + " : "
		 + Boolean.toString(cntdwn1.isButtonNoPressed()));
		 ...
		 cntdwn2.Start();
		 cntdwnltch2.await();
		 logger.println(Boolean.toString(cntdwn2.isButtonYesPressed()) + " : "
		 + Boolean.toString(cntdwn2.isButtonNoPressed()));
		 ...
		 cntdwn3.Start();
		 cntdwnltch3.await();
		 logger.println(Boolean.toString(cntdwn3.isButtonYesPressed()) + " : "
		 + Boolean.toString(cntdwn3.isButtonNoPressed()));
		 ...
		 cntdwn4.Start();
		 cntdwnltch4.await();
		 logger.println(Boolean.toString(cntdwn4.isButtonYesPressed()) + " : "
		 + Boolean.toString(cntdwn4.isButtonNoPressed()));
		 ...
		 cntdwn5.stop();
		 cntdwnltch5.await();
		 logger.println(Boolean.toString(cntdwn5.isButtonYesPressed()) + " : "
		 + Boolean.toString(cntdwn5.isButtonNoPressed()));
		...
		cntdwn6.setStr4("");
		cntdwn6.Start();
		logger.println(Boolean.toString(cntdwn6.isButtonYesPressed()) + " : " + Boolean.toString(cntdwn6.isButtonNoPressed()));
		...
		cntdwnltch7.await();
		logger.println(Boolean.toString(cntdwn6.isButtonYesPressed()) + " : " + Boolean.toString(cntdwn6.isButtonNoPressed()));
		logger.println(Boolean.toString(cntdwn7.isButtonYesPressed()) + " : " + Boolean.toString(cntdwn7.isButtonNoPressed()));
		// --------------------------------------------------------------------------------------------
